...
| Tiêu chí | Bài báo gốc (Galli et al. 2024) | Bản Nâng Cấp Hiện Tại (Master Level) | Đánh giá Giá Trị Học Thuật |
| :--- | :--- | :--- | :--- |
...
Tại thư mục chứa dự án `UIT -SDH/CCHDMD/XAI/`, mở Terminal lên và gõ:
...
* *(Quá trình này bạn chỉ cần phải chạy 1 lần. Đợi khoảng 2-3 phút cho các thanh Loading tiến tới 100%)*
...
* Tại đây bạn tha hồ ấn chọn các Mẫu Mã Độc, hệ thống sẽ Hightlight trực tiếp những chuỗi lệnh nguy hiểm lên màn hình để có cứ liệu thuyết trình.

---
*(Bản báo cáo kỹ thuật này có thể được copy/chụp thẳng vào mục "Cải tiến so với Đề xuất" trong Slide báo cáo luận văn của bạn!)*
